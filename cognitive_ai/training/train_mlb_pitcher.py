...
def train_pitcher():
    ...
    os.makedirs("./checkpoints/mlb_pitcher_best", exist_ok=True)
    ...
    eval_cb = EvalCallback(
        eval_env,
        best_model_save_path='./checkpoints/mlb_pitcher_best',
        eval_freq=2000,
        n_eval_episodes=25,
        deterministic=True
    )
    ...
    model.learn(total_timesteps=200000, callback=eval_cb)
    model.save("./checkpoints/pitcher_final_model")
    vec_env.save("./checkpoints/mlb_pitcher_vec_normalize.pkl")
